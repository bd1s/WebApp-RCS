...
router.put('/convention-stage/:id_demande', verifyToken, upload.single('fichier_demande_stage'), demandeController.updateDemande);
router.put('/cotutelle/:id_demande', verifyToken, upload.single('fichier_demande_cotutelle'), demandeController.updateDemande);
router.put('/changement-codirecteur-these/:id_demande', verifyToken, upload.single('fichier_demande_changement_codirecteur'), demandeController.updateDemande);
router.put('/imists/:id_demande', verifyToken, upload.single('fichiers_cv'), demandeController.updateDemande);
router.put('/tirage/:id_demande', verifyToken, upload.single('fichier_demande_tirage'), demandeController.updateDemande);
