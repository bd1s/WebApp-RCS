...
const DemandeForm = () => {
  ...
  demandeData: {
    ...
    motif_demande: '',
    entreprise_accueil: '', // convention-stage
    periode_stage: '', // convention-stage
    objectifs_stage: '', // convention-stage
    fichier_demande_stage: null, // convention-stage
    universite_partenaire: '', // cotutelle
    pays: '', // cotutelle
    duree_cotutelle: '', // cotutelle
    fichier_demande_cotutelle: null, // cotutelle
    co_directeur_actuel: '', // changement-codirecteur-these
    nouveau_co_directeur_propose: '', // changement-codirecteur-these
    motifs_changement: '', // changement-codirecteur-these
    fichier_demande_changement_codirecteur: null, // changement-codirecteur-these
    titre_these: '', // imists, tirage
    directeur_these: '', // imists
    date_debut_these: '', // imists
    date_prevue_soutenance: '', // imists
    fichiers_cv: null, // imists
    nombre_exemplaires: '', // tirage
    date_soutenance: '', // tirage
    fichier_demande_tirage: null, // tirage
  },
    date_soumission: new Date().toISOString(),
  });
